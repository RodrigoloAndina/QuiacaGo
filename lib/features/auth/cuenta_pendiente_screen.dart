        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'SOLICITUD EN REVISIÓN MUNICIPAL',
              ...
              // Caja destacada con el mensaje oficial solicitado
              Container(
                ...
                child: Column(
                  children: const [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'Hemos recibido tu solicitud de habilitación, estamos revisándola.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w800,
              ...
              // Botón WhatsApp al Administrador
              SizedBox(
                width: double.infinity,
                height: 52,
